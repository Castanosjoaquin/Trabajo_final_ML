...
# Columnas ERA5-Land derivadas que produce extract_era5.py. Se definen acá para
# que data_sources/ sea infra compartida e independiente de cualquier componente.
