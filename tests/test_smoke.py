...
No requieren datos reales ni W&B activo.
"""
...
def test_wandb_not_required():
    """Los detectores deep funcionan sin W&B activo."""
...
def test_import_backward_compat():
    ...
    from componente_a.models import IsolationForestDetector as IFD  # noqa: F401
